...
-- Thu muc: database/seed_data/
-- Mo ta: Chen du lieu mau (DML) vao Database de chay va kiem thu he thong
-- =======================================================
...
-- 7. Ghi nhan lich su mau (Employee History)
